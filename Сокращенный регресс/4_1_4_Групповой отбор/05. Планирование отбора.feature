...
Сценарий: [005] планирование отбора
	...
	И таблица 'Список' содержит строки:
		| "Статус"       | "Количество" | "Объект хранения"         | "Тип операции"            | "Дата партии"     |
		| "Спланирована" | "3,000"      | "Фотоаппарат"             | "Отбор объектов хранения" | "08.08.2023"      |
		| "Спланирована" | "300,000"    | "Спрей для чистки матриц" | "Отбор объектов хранения" | "18.07.2023"      |   // здесь партия       
	И я закрываю все окна клиентского приложения
