...
Сценарий: [003] Выполнение приемки МХ№1 (Блок питания по 10 коробок)
...
Сценарий: [004] Выполнение приемки МХ№2 (Блок питания по 10 коробок)
	И я закрываю все окна клиентского приложения
	И В командном интерфейсе я выбираю "Поступление" "Приемка (пересчет)"
	И я нажимаю на кнопку с именем 'ФормаСоздать'
	*Заполняем поля в задаче
...
Сценарий: [005] Выполнение приемки МХ№3 (Блок питания 90 шт)
	И я закрываю все окна клиентского приложения
	И В командном интерфейсе я выбираю "Поступление" "Приемка (пересчет)"
	И я нажимаю на кнопку с именем 'ФормаСоздать'
*Заполняем поля в задаче
...
Сценарий: [006] Выполнение приемки МХ№4 (Блок питания 10 шт Брак)
	И я закрываю все окна клиентского приложения
	И В командном интерфейсе я выбираю "Поступление" "Приемка (пересчет)"
	И я нажимаю на кнопку с именем 'ФормаСоздать'
*Заполняем поля в задаче
...
Сценарий: [007] Выполнение приемки МХ№ 5,6,7 (Разъем по 100 кор на поддон)
	И я делаю 3 раз
		И я закрываю все окна клиентского приложения
		И В командном интерфейсе я выбираю "Поступление" "Приемка (пересчет)"
		И я нажимаю на кнопку с именем 'ФормаСоздать'
...
Сценарий: [008] Выполнение приемки МХ№ 8,9,10,11 (Кабель по 12 пач на поддон)
	И я делаю 4 раз
		И я закрываю все окна клиентского приложения
		И В командном интерфейсе я выбираю "Поступление" "Приемка (пересчет)"
		И я нажимаю на кнопку с именем 'ФормаСоздать'
	...
	Сценарий: [009] Завершение приемки (завершение ОП)
		И я закрываю все окна клиентского приложения
		И Я открываю навигационную ссылку "$$СсылкаОП$$"
		Тогда таблица 'Строки' содержит строки:
