...
Функционал: [0069] планирование отбора при отгрузку с контролем по составу
...
* проверка отчета Задачи по документу
	...
	Тогда таблица 'Список' содержит строки:
		| "Статус"       | "Количество" | "Объект хранения" | "Тип операции"            | "Начальная зона"          | "Начальное место хранения 1" | "Состояние" | "Партия"     | "Конечная зона"   |
