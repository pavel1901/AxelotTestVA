...
Функционал: [004]Проверка отчетов
...
Сценарий: Проверка отчета план-факт поступления
	...
	И табличный документ 'ОтчетТабличныйДокумент' содержит строки:
		...
		| 'Объект хранения'                                 | ''                                                                              | ''           | ''          | ''                  | ''          | ''                 | ''          | ''            | ''           | ''           |
		| 'Состояние'                                       | 'Партия'                                                                        | ''           | ''          | ''                  | ''          | ''                 | ''          | ''            | ''           | ''           |
		| '*'                                               | 'К выполнению'                                                                  | '15 348,000' | '5 348,000' | ''                  | ''          | '10 000,000'       | ''          | ''            | '15 348,000' | '15 348,000' |
		...
		| 'Годен'                                           | ''                                                                              | ''           | '48,000'    | ''                  | ''          | ''                 | '48,000'    | ''            | ''           | ''           |
		| 'Разъем 3.5 мм'                                   | ''                                                                              | '15 000,000' | '5 000,000' | ''                  | ''          | '10 000,000'       | ''          | ''            | '15 000,000' | '15 000,000' |
		| ''                                                | ''                                                                              | '15 000,000' | ''          | ''                  | ''          | '15 000,000'       | ''          | ''            | '15 000,000' | '15 000,000' |
		| 'Годен'                                           | ''                                                                              | ''           | '5 000,000' | ''                  | ''          | ''                 | '5 000,000' | ''            | ''           | ''           |
		| 'Итого'                                           | ''                                                                              | '15 348,000' | '5 348,000' | ''                  | ''          | '10 000,000'       | ''          | ''            | '15 348,000' | '15 348,000' |

Сценарий: Проверка отчета план-факт поступления в упаковках
	И я закрываю все окна клиентского приложения
	...
	И табличный документ 'ОтчетТабличныйДокумент' содержит строки:
		...
		| 'Состояние'                                       | 'Партия'               | ''                               | ''                               | ''                                            | ''                                    | ''                                           | ''                                  |
		| '*'                                               | 'К выполнению'         | '378,000'                        | '178,000'                        | ''                                            | ''                                    | '200,000'                                    | ''                                  |
		...
		| ''                                                | ''                     | '48,000'                         | ''                               | ''                                            | ''                                    | '48,000'                                     | ''                                  |
		| 'Годен'                                           | ''                     | ''                               | '48,000'                         | ''                                            | ''                                    | ''                                           | '48,000'                            |
		| 'Разъем 3.5 мм'                                   | 'кор.'                 | '300,000'                        | '100,000'                        | ''                                            | ''                                    | '200,000'                                    | ''                                  |
		| ''                                                | ''                     | '300,000'                        | ''                               | ''                                            | ''                                    | '300,000'                                    | ''                                  |
		| 'Годен'                                           | ''                     | ''                               | '100,000'                        | ''                                            | ''                                    | ''                                           | '100,000'                           |
		| 'Итого'                                           | ''                     | '378,000'                        | '178,000'                        | ''                                            | ''                                    | '200,000'                                    | ''                                  |
		
Сценарий: Проверка отчета анализ поступления
	И я закрываю все окна клиентского приложения
	И В командном интерфейсе я выбираю "Поступление" "Отчеты по поступлению"
	...
	И табличный документ 'ОтчетТабличныйДокумент' содержит строки:
		...
		| '*'                                               | ''         | ''          | '5 348'      | '9'                   |
		| 'DOC-1'                                           | 'Приемка'  | 'Доступно'  | '5 348'      | '9'                   |
